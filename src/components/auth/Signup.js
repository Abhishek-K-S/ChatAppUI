            ...
            <div className='col'>
                <form onSubmit={submitHandler}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="name" placeholder='Example: John' onChange={(e)=>setName(e.target.value)} value ={name} aria-describedby="nameError"/>
                        <small id="nameError" className="form-text text-danger ">{nameError}</small>
                    </div>
                    <div className="form-group">
